...
from keras.callbacks import EarlyStopping # Pour arrêter l'entraînement si la validation ne s'améliore pas  
...
history = model.fit(
    ...
    #callbacks        = [early_stop]  # Arrête l'entraînement si la validation ne s'améliore pas pendant 5 epochs    
)
